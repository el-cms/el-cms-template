...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		this.componentReset = this.element.is('.date') ? ( this.bootcssVer == 3 ? this.element.find('.input-group-addon .fa-times').parent() : this.element.find('.add-on .icon-times').parent()) : false;
